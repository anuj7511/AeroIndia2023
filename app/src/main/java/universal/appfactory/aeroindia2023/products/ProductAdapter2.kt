...
class ProductAdapter2(private val mList: ArrayList<ProductModel2>, private val mContext: Context, private val category: String) : RecyclerView.Adapter<ProductAdapter2.ViewHolder>() {

    // creating a variable for array list and context.
    private var productModelArrayList: ArrayList<ProductModel2>

    // method for filtering our recyclerview items.
    fun filterList(filterList: ArrayList<ProductModel2>) {
    ...
    init {
        this.productModelArrayList = when (category) {
            "second" -> mList.distinctBy { it.getSecond_categoy() } as ArrayList<ProductModel2>
            "third" -> mList.distinctBy { it.getThird_categoy() } as ArrayList<ProductModel2>
            "last" -> mList
            else -> mList.distinctBy { it.getFirst_category() } as ArrayList<ProductModel2>
        }
    }

    private fun intentToSelectedProduct(itemsViewModel: ProductModel2) {
